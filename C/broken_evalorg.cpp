...
int main(int argc, char *argv[]){
  ...
  string const fpath_err = "/Users/tkm/programming/c/error/broken_evalorg/";
  ofstream fvq;
  ofstream fl;
  dmat x;
  dmat t;
  ...
  if(argc > 1 && argc <= 7){
    ...
    cout << "\t\"/evalorg [Num of RepPt] [leaening time(Per)] [leaening time(SOM)] [dataset's filename(DO NOT INCLUDE EXTENSION)] [none or pp]\"" << endl;
    exit(-1);
  }
