...
int main(int argc, char *argv[]){
  ...
  string const fpath_err = "/Users/tkm/programming/c/error/evalorg/";
  ofstream fvq;
  ofstream fl;
  dmat x;
  dmat t;
  ...
  fname_vq_err = fpath_err + fname + "_vq_error(lt=" + lexical_cast<string>(som_lt) + ").dat";
  fname_learn_err = fpath_err + fname + "_learn_error(som_lt=" + lexical_cast<string>(som_lt) + ", per_lt=" + lexical_cast<string>(per_lt) + ").dat";
