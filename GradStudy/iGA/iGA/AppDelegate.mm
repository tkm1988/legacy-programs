...
//  UIViewController *initViewController = [[PatternSimilarityViewController alloc] init];
  UIViewController *initViewController = [[FirstViewController alloc] init];
  ...
  [self.window bringSubviewToFront:initViewController.view];
